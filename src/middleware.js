...
export function middleware(request) {
  ...
  // IMPORTANT: Agregado Microsoft Clarity y Plausible para analítica
  // ADICIONAL: También agregado scripts.clarity.ms para permitir carga de scripts dinámicos
  const cspHeader = [
    "default-src 'self'",
    "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://cdn.prod.website-files.com https://www.clarity.ms https://clarity.ms https://scripts.clarity.ms https://plausible.io",
    "style-src 'self' 'unsafe-inline'",
    "img-src 'self' data: https: blob:",
    "font-src 'self' data:",
    "connect-src 'self' https: wss: https://www.clarity.ms https://clarity.ms https://scripts.clarity.ms https://plausible.io",
