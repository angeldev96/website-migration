    ...
    <main className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4">
        {user?.role === 'CORPORATION' && (
          <div className="max-w-6xl mx-auto mb-8 bg-purple-50 border border-purple-100 rounded-2xl p-6 flex items-center justify-between">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="flex flex-col items-center text-center p-4 bg-blue-50 rounded-2xl border border-blue-100">
                      ...
                      <p className="text-xs text-gray-600">admin@yiddishjobs.com</p>
                    </div>
