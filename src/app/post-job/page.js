              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <label className="block">
                    ...
                    <input name="location" value={form.location} onChange={handleChange} className="mt-2 block w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-gray-900 placeholder-gray-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Brooklyn / New York" />
                  </label>
